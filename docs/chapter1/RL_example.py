...
def play(env, agent, render=False, train=False):
    ...
    while True:  # 不断循环，直到回合结束
        ...
        if done or truncated:  # 回合结束，跳出循环
            break
    return episode_reward  # 返回回合总奖励

# Gym environment setup
env = gym.make('MountainCar-v0')
# gym("MountainCar-v0", render_mode="rgb_array")
env.action_space.seed(3)  # 设置随机种子，让结果可复现
...
# Play 100 episodes without rendering and compute average reward
